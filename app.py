...
SALARYMAN_EVENTS = [
    {"text": "プロジェクトリーダーに抜擢！", "img": "images/leader.png", "money": 30},
    {"text": "夏のボーナス支給！", "img": "images/bonus.png", "money": 50},
    {"text": "クライアントから感謝のメール", "img": "images/leader.png", "money": 10},
    {"text": "効率化を提案し、部署表彰される", "img": "images/bonus.png", "money": 20},
    {"text": "定時退社！自分へのご褒美", "img": "images/leader.png", "money": -5},
    {"text": "資格取得手当で収入アップ", "img": "images/bonus.png", "money": 15},
    {"text": "会社からの独立を夢見て自己啓発本購入", "img": "images/leader.png", "money": -5},
    {"text": "同僚の結婚式でご祝儀", "img": "images/bonus.png", "money": -30},
    {"text": "飲み会で羽目を外してタクシー帰宅", "img": "images/leader.png", "money": -10},
    {"text": "突然のPC故障で買い替え", "img": "images/bonus.png", "money": -20},
    {"text": "重要な会議で大成功！", "img": "images/leader.png", "money": 25},
    {"text": "社員旅行でリフレッシュ", "img": "images/bonus.png", "money": -5},
    {"text": "納期に追われて深夜残業（振替休日あり）", "img": "images/leader.png", "money": -5},
    {"text": "昇進して基本給アップ", "img": "images/bonus.png", "money": 40},
    {"text": "誤送信メールのフォローで冷や汗", "img": "images/leader.png", "money": -10},
    {"text": "営業先で美味しいランチをご馳走になる", "img": "images/bonus.png", "money": 5},
    {"text": "健康診断で再検査の診断", "img": "images/leader.png", "money": -15},
    {"text": "新しいスーツを新調", "img": "images/bonus.png", "money": -20},
    {"text": "プチーム目標達成で報奨金", "img": "images/leader.png", "money": 20},
    {"text": "慣れない事務処理でミス連発", "img": "images/bonus.png", "money": -10} ... 他の18種をここに追加
]
JOB_EVENTS = [
